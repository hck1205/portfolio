...
const semanticColorTokens = [
  ...
  createColorToken("Semantic/Intent/Primary/Base", colorScale.Indigo.solid[5], "Primary action fill"),
  createColorToken("Semantic/Intent/Primary/Hover", colorScale.Indigo.solid[6], "Primary action hover fill"),
